...
pub enum TokenKind {
    ...
    #[token("tuple")]  Tuple,
    #[token("lazy")]   Lazy,
    #[token("times")]  Times, // contextual, but reserved at lexer level for safety
    ...
    #[token("u64")]     U64Ty,
    #[token("float")]   FloatTy,
    #[token("float32")] Float32Ty,
    #[token("float64")] Float64Ty,
    #[token("string")]  StringTy,
    #[token("bytes")]   BytesTy,
    ...
    #[token("-->")] Uninhabited, // intentionally unused; prevents `->` + `-` ambiguity notes
    #[token("..")] DotDot,
    #[token("->")] Arrow,
    #[token("=>")] FatArrow,
    #[token("|>")] Pipe,
...
impl TokenKind {
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ...
            TokenKind::StrLit | TokenKind::FStrLit
            | TokenKind::TripleStrLit | TokenKind::TripleFStrLit => "string literal",
