...
| **LANG-MEM-4** | RC elision in codegen | 3 | L | partial | **2026-07-17**: action 1/3 done — return-transfer elision (returning a managed local hands the binding's +1 to the caller; retain+release pair removed, `make_list`-style builders drop to zero RC ops). Remaining: S6 expression temps audit, S7 loop-rebind confirmation. Note: [`historico/nim-study-2026-07-17-c4-c7.md`](historico/nim-study-2026-07-17-c4-c7.md) |
