...
- **M2.result-ctors (planejado):** renomear construtores/padrões de `result` de `success`/`error` para **`ok`/`err`** — ver `docs/planning/result-ctors-ok-err.md` (ainda não implementado).
